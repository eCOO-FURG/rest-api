...
import { createRegisterOfferSchema } from "@/infra/http/controllers/register-offer";
...
const { swagger: registerOfferSchemaSwagger } = j2s(createRegisterOfferSchema(false));
