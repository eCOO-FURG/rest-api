...
export type BoxRepositoryReturnType = "box" | "box-and-catalog" | "box-and-orders";
...
export interface BoxesRepository {
  find<T extends BoxRepositoryReturnType>(type: T, filters: BoxesRepositorySearchRequest): Promise<BoxEntityOf<T> | null>;
  list<T extends BoxRepositoryReturnType>(type: T, filters: BoxesRepositorySearchRequest, page?: number): Promise<BoxEntityOf<T>[]>;
