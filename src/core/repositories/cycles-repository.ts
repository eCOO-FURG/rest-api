...
export interface CyclesRepository {
  find<T extends CycleRepositoryReturnType>(type: T, filters: CyclesRepositorySearchRequest): Promise<CycleEntityOf<T> | null>;
  list<T extends CycleRepositoryReturnType>(type: T, filters: CyclesRepositorySearchRequest, page?: number): Promise<CycleEntityOf<T>[]>;
}
